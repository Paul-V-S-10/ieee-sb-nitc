...
export default function EventsCarousel({ title = "Latest Events", showTitle = true }) {
  ...
  return (
    <div className="events-carousel-container">
              ...
              <SwiperSlide key={event.id} className="events-slide">
                <div className="events-card">
                  <div className="events-card-image-container">
                    <img src={event.image || "/placeholder.svg"} alt={event.title} className="events-card-image" />
                  </div>
      ...
      <div className="events-navigation-container">
        <button onClick={handlePrevClick} className="events-nav-button events-prev-button">
        ...
        <button onClick={handleNextClick} className="events-nav-button events-next-button">
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
